  ...
  const contactInfo = [
    {
      icon: FaEnvelope,
      label: "Email",
      value: "abdi.lamu@example.com",
      href: "mailto:abdi.lamu@example.com",
    },
    {
      icon: FaPhone,
      label: "Phone",
  ...
  const socialLinks = [
    {
      icon: FaLinkedin,
      label: "LinkedIn",
      href: "https://linkedin.com/in/abdi-lamu",
      color: "blue.500",
    },
    {
      icon: FaGithub,
      label: "GitHub",
      href: "https://github.com/abdi-lamu",
      color: "gray.700",
    },
    {
      icon: FaTwitter,
      label: "Twitter",
      href: "https://twitter.com/abdi_lamu",
      color: "blue.400",
    },
  ];
